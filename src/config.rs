...
pub fn make_memory_limits(mut usage: u32) -> (usize, usize, Option<usize>, Option<usize>) {
    ...
    match usage {
        ...
        5 => (S_1MIB, S_8MIB, Some(S_512KIB), Some(S_1MIB)),
        6 => (S_2MIB, S_16MIB, Some(S_1MIB), Some(S_4MIB)),
        7 => (S_4MIB, S_32MIB, Some(S_2MIB), Some(S_8MIB)),
        8 => (S_8MIB, S_64MIB, Some(S_4MIB), Some(S_16MIB)),
        9 => (S_16MIB, S_128MIB, Some(S_8MIB), Some(S_32MIB)),
        10 => (S_16MIB, S_256MIB, Some(S_8MIB), Some(S_32MIB)),
        11 => (S_32MIB, S_1GIB, Some(S_16MIB), Some(S_128MIB)),
        _ => unreachable!(),
    }
}
